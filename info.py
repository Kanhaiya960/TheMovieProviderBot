...
URL = "https://compact-dolores-telegra0-08896c20.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://compact-dolores-telegra0-08896c20.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://compact-dolores-telegra0-08896c20.koyeb.app/".format(FQDN)
else:
    URL = "https://compact-dolores-telegra0-08896c20.koyeb.app/".format(FQDN)
