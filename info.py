...
API_ID = int(environ.get('API_ID', '27116256'))
API_HASH = environ.get('API_HASH', '89669f3ecf7d5257926a50701371100b')
BOT_TOKEN = environ.get('BOT_TOKEN', "6713025269:AAH6hwgk-g8N55LUZ8KeW-WT0VHynQ8Hj38")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6496758514').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Anshu01:Anshu01@cluster0.vhtlpsp.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c274fdac41fa23e515df64ac4c391fd496476734')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/marvelsbackups/38') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002036619716')) #Log channel id ( make sure bot is admin )
...
URL = "https://tomandjerstreamsivam-4c7e90fa9181.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tomandjerstreamsivam-4c7e90fa9181.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tomandjerstreamsivam-4c7e90fa9181.herokuapp.com/".format(FQDN)
else:
    URL = "https://tomandjerstreamsivam-4c7e90fa9181.herokuapp.com/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002036619716'))
