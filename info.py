...
URL = "https://prosearchbotz-342ddfe440cf.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://prosearchbotz-342ddfe440cf.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://prosearchbotz-342ddfe440cf.herokuapp.com/".format(FQDN)
else:
    URL = "https://prosearchbotz-342ddfe440cf.herokuapp.com/".format(FQDN)
