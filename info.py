...
URL = "https://related-cassey-marvelbotz-537bfb8c.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://related-cassey-marvelbotz-537bfb8c.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://related-cassey-marvelbotz-537bfb8c.koyeb.app/".format(FQDN)
else:
    URL = "https://related-cassey-marvelbotz-537bfb8c.koyeb.app/".format(FQDN)
