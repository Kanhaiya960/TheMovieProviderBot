...
API_HASH = environ.get('API_HASH', 'd00a58893f62b37639c687fad05c805c')
...
URL = "http://gradual-claresta-sakshi01-29adc462.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://gradual-claresta-sakshi01-29adc462.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "http://gradual-claresta-sakshi01-29adc462.koyeb.app/".format(FQDN)
else:
    URL = "http://gradual-claresta-sakshi01-29adc462.koyeb.app/".format(FQDN)
