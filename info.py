...
auth_channel = environ.get('AUTH_CHANNEL', '-1002232839951') #Channel / Group Id for force sub ( make sure bot is admin )
...
URL = "https://stupid-gabriellia-friendship-f3ee128c.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://stupid-gabriellia-friendship-f3ee128c.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://stupid-gabriellia-friendship-f3ee128c.koyeb.app/".format(FQDN)
else:
    URL = "https://stupid-gabriellia-friendship-f3ee128c.koyeb.app/".format(FQDN)
