...
URL = "https://advancefilter-1.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://advancefilter-1.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://advancefilter-1.onrender.com/".format(FQDN)
else:
    URL = "https://advancefilter-1.onrender.com/".format(FQDN)
