...
URL = "https://tomandjerstrmsivam-f9cd862c54d1.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tomandjerstrmsivam-f9cd862c54d1.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tomandjerstrmsivam-f9cd862c54d1.herokuapp.com/".format(FQDN)
else:
    URL = "https://tomandjerstrmsivam-f9cd862c54d1.herokuapp.com/".format(FQDN)
