...
URL = "https://tomandjerstreamsivm-48ea30d0a925.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tomandjerstreamsivm-48ea30d0a925.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tomandjerstreamsivm-48ea30d0a925.herokuapp.com/".format(FQDN)
else:
    URL = "https://tomandjerstreamsivm-48ea30d0a925.herokuapp.com/".format(FQDN)
